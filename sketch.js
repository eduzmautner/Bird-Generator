...
function setup() {
  ...
  legHeight = createSlider(10,31,0,0.5);
  ...
  camera(100,-40,70,0,0,0);//oficial camera w/o Mouse control
}
...
function draw() {
  ...
  //legs
  push();
  translate(widthBody.value()/2 - 2,heightBody.value()/2+5.7,0)
  stroke('#E36E20')
  ...
  translate(0,heightBody.value()/2 + legHeight.value()/2,0);//controls both feet's height
    ...
    ambientMaterial('#E36E20');
      beginShape();//right foot
        vertex(-8,5.7,-0.5)//ankle -> left toe
        vertex(-4 + feetSize.value(),5.7,10 + feetSize.value()*1.75)//left toe -> right toe
        vertex(-12 - feetSize.value(),5.7,10 + feetSize.value()*1.75)//right toe -> ankle
      endShape(CLOSE);
    pop();
    push();
      ...
      ambientMaterial('#E36E20');
        vertex(8,5.7,-0.5)//ankle->left toe
        vertex(12 + feetSize.value(),5.7,10 + feetSize.value()*1.75)//left toe -> right toe
        vertex(4 - feetSize.value(),5.7,10 + feetSize.value()*1.75)//right toe->ankle
      endShape(CLOSE);
    pop();
  pop();
